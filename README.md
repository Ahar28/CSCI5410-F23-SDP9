...
```
cd existing_repo
git remote add origin https://git.cs.dal.ca/hmehta/csci5410-f23-sdp9.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.cs.dal.ca/hmehta/csci5410-f23-sdp9/-/settings/integrations)
